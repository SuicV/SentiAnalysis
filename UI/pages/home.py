...
def home():
    ...
    st.markdown("<h5 style='text-align: center'>Nowadays, the abundance of online reviews about products and services, might be an indicator for business, especially hotels about their performance and the satisfaction of their clients.<br /> For this reason, we created a system for sentiment analysis of online reviews, to analyze sentiment about different aspects of an hotel.</h5>", unsafe_allow_html=True)
    ...
    st.markdown("3- Sentiment Classification")
